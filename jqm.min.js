...
function A(a,c,b,e){c=x(c);if(c.ns)var d=RegExp("(?:^| )"+c.ns.replace(" "," .* ?")+"(?: |$)");return(p.get(a)||[]).filter(function(a){return a&&(!c.e||a.e==c.e)&&(!c.ns||d.test(a.ns))&&(!b||a.fn==b||typeof a.fn==="function"&&typeof b==="function"&&""+a.fn===""+b)&&(!e||a.sel==e)})}
...
function q(a,c,b,e,f){var g;(g=p.get(a))||p.set(a,g=[]);y(c,b,function(b,c){var i=f&&f(c,b),j=i||c,k=function(b){var c=b.data?j.apply(a,[b].concat(b.data)):j.call(a,b);c===!1&&b.preventDefault();return c},i=d.extend(x(b),{fn:c,proxy:k,sel:e,del:i,i:g.length});g.push(i);a.addEventListener(i.e,k,!1)})}
function r(a,c,b,e){var d=p.get(a);y(c||"",b,function(b,c){A(a,b,c,e).forEach(function(b){d&&delete d[b.i];a.removeEventListener(b.e,b.proxy,!1)})})}
...
var f,g=window,j=document,l=Array.prototype,s=[],H=/^\s*<(\w+)[^>]*>/,k={},p=new WeakMap,
...
d.each=function(a,c){var b;if(d.isArray(a))for(b=0;b<a.length;b++){if(c(b,a[b])===!1)break}else if(d.isObject(a))for(b in a)if(Object.prototype.hasOwnProperty.call(a,b)&&c(b,a[b])===!1)break;return a};
